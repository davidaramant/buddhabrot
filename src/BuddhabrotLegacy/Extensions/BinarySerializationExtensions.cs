...
public static class BinarySerializationExtensions
{
    ...
    public static DoubleRange ReadRange(this BinaryReader reader) => new(reader.ReadDouble(), reader.ReadDouble());
    ...
    public static ComplexArea ReadComplexArea(this BinaryReader reader) => new(reader.ReadRange(), reader.ReadRange());
    ...
    public static Size ReadSize(this BinaryReader reader) => new(reader.ReadInt32(), reader.ReadInt32());
    ...
    public static ViewPort ReadViewPort(this BinaryReader reader) => new(reader.ReadComplexArea(), reader.ReadSize());
    ...
    public static Point ReadPoint(this BinaryReader reader) => new(reader.ReadInt32(), reader.ReadInt32());
